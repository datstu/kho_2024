        ...
        if ($dataFilter) {
            ...
            */
            ...
            if (isset($dataFilter['mkt'])) {
                ...
                $listSrcByMkt = SrcPage::orderBy('id', 'asc')->where('user_digital', $dataFilter['mkt']);
                ...
                */
                ...
                $list = SaleCare::orderBy('id', 'asc')->whereIn('id', $newIdSaleCare);
            }
