...
<div class="body flex-grow-1 px-3">
    <div class="row">
        <?php 
        foreach ($errors->getMessages() as $kE => $error) {
                    ...
                    <div class="example">
                        <div class="body flex-grow-1">
                            <div class="tab-content rounded-bottom">
                                <form method="POST" action="{{ route('save-orders') }}">
                                    {{ csrf_field() }}
                                        ...
                                        @endif
                                            ...
                                            <div class="col-lg-5">
                                                <div class="row product-list-order">
                                                    ...
                                                    <div id="sum_qty" class=" col-4">
                                                        <label class="form-label">Tổng số lượng</label>
                                                        <input value="{{$order->qty}}" name="sum_qty" class="form-control" disabled
                                                            type="number">
                                                        <p class="error_msg" id="qty"></p>
                                                    </div>
                                                </div>
                ...
                <div class="body flex-grow-1">
                    <div class="tab-content rounded-bottom">
                        <form method="POST" action="{{ route('save-orders') }}">
                                ...
                                <div class="col-sm-12 col-lg-7">
                                    <div class="row product-list-order">
                                        ...
                                        <div id="sum_qty" class=" col-4 ">
                                            ...
                                            <input value=0 name="sum_qty" class="form-control" readonly
                                                type="number">
                                            <p class="error_msg "></p>
                                        </div>
                                    </div>
                            ...
                            <button id="submit" type="submit" class="btn btn-primary">Tạo</button>
...
function deleteProduct(id, price) {
    ...
    var $inputQty = $('#sum_qty').find('input');
...
$(document).ready(function() {
    ...
    $("#submit").click(function(e) {
        ...
        var qty         = $("input[name='sum_qty']").val();
        ...
        $(".number input").each(function(index) {
            ...
            $("input[name='products']").val(JSON.stringify(listProduct));
