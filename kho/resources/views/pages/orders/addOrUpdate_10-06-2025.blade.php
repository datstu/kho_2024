...
<style>
    ...
    .select-attribute .select2-container .select2-selection--single {
        height: 20px;
    }
    .select-attribute .select2-container--default .select2-selection--single .select2-selection__rendered {
        line-height: 20px;
    }

    .select-attribute .select2-container--default .select2-selection--single .select2-selection__arrow {
        height: 20px;
    }
    ...
    .select-attribute .select2-selection__rendered {
                    ...
                    <td class="text-left">
                        ...
                        <div class="select-attribute">
                            <label class="" for="{{$attribute->id}}-filter">{{$attribute->name}}</label>
                                <select name="attribute-{{$attribute->id}}" id="{{$attribute->id}}-filter" class="form-control">       
...
<script>
    $(function() {
        ...
        $('#ward-filter').select2();
        <?php   foreach ($listAttribute as $attribute) {
            echo ( '$("#' . $attribute->id . '-filter").select2();');
        }
         ?>
    });
</script>
