...
<div class="tab-content rounded-bottom">
  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1001">
    <div class="row">
      ...
      @if ($checkAll)
      <div class="col col-4">
        <a class="add-order btn btn-primary" href="{{route('add-group-sale')}}" role="button">+ Thêm nhóm</a>
      </div>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$gr->created_at}}</td>
                <td scope="col-1">
                  <a class="btn btn-warning" href="{{route('update-group-sale',['id'=>$gr->id])}}" role="button">
                      <svg class="icon me-2">
                ...
                <td scope="col-1">
                  <a class="btn btn-danger active" onclick="return confirm('Bạn muốn xóa đơn này?')" href="{{route('delete-group-sale',['id'=>$gr->id])}}" role="button">
                    <svg class="icon me-2">
